                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title ">List Tema</h3>
                            <a href="{{ route('tema.create') }}" class="btn btn-primary">Create</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-right">
                                                        <a href="{{ route('tema.edit', $item->id) }}"
                                                            class="btn btn-warning">
                                                            <i class="fas fa-edit fa-sm text-white-60"></i>
                                                            <span>Edit</span>
                                                        </a>
                                                        <a
                                                            onclick="return confirm('Yakin untuk menghapus tema {{$item->title}}? ')">
                                                            <form action="{{ route('tema.destroy', $item->id) }}"
